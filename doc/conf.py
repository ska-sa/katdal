...
latex_documents = [
    (master_doc, 'katdal.tex', 'katdal Documentation',
     'Ludwig Schwardt', 'manual'),
]
...
man_pages = [
    (master_doc, 'katdal', 'katdal Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'katdal', 'katdal Documentation',
     author, 'katdal', 'One line description of project.',
     'Miscellaneous'),
]
